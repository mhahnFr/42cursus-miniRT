...
UTILS_SRC  = arraylist.c arraylist_array.c arraylist_array_unsafe.c arraylist_get.c \
              ...
              abs.c matrix.c matrix_calculations.c matrix_destroy.c matrix_filler.c \
...
VPATH	= src/ src/painter/ src/calculator/ src/lexer/ src/parser/ utils/ utils/math/ utils/gnl/

SRC = builder.c main.c mixer.c mt.c mt1.c mt2.c cli1.c cli2.c calculator.c color.c diffuse.c sphere.c plane.c \
      baseimage.c specular.c shaders.c light_obj_intersection.c diffuse_intersection.c cylinder_norm.c \
      cylinder_norm_a.c cylinder_norm_b.c cube.c lexer.c validator.c basic_check.c type_check.c object_check.c \
      normal_corrector.c parser.c object_pars.c basic_pars.c parser2.c cy_pars.c cub_pars.c renderer_image.c key_handler.c
